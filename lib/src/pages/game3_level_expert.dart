...
class Game3LevelExpert extends StatefulWidget {
  @override
  _Game3LevelExpertState createState() => _Game3LevelExpertState();
}

class _Game3LevelExpertState extends State<Game3LevelExpert> {
  int coins = 0;
  int hearts = 3;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20.0),
                    Image.asset('assets/images/foley_nivel_experto_ls.png'),  // Asegúrate de actualizar la ruta de la imagen si es diferente.
                    SizedBox(height: 20.0),
                    Center(
                      child: Column(
                        children: [
