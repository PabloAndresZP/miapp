...
class _GameLevelIntermediateState extends State<GameLevelIntermediate> {
  ...
  int completedExercises = 2; //bartra de progreso
  int coins = 0;
  int hearts = 2;
  List<int> correctAnswers = [1, 0];
  int currentExerciseIndex = 0;
  List<String> exerciseImages = [
    'assets/images/desierto.png',
    
  ];
  List<String> exerciseAudios1 = [
    'assets/sounds/escmenormelodica.mp3',
    'assets/sounds/escmenormelodica.mp3',
  ];
  List<String> exerciseAudios2 = [
    'assets/sounds/escmenorarmonica.mp3',
    'assets/sounds/escmenorarmonica.mp3',
  ];
  ...
  if (currentPlaying) {
    ...
    String assetToPlay = (playerNumber == 1)
        ? 'sounds/escmenormelodica.mp3'
        : 'sounds/escmenorarmonica.mp3';
 ...
 void _checkAnswer() {
  ...
  onTap: () {
    ...
    setState(() {}); // Esta llamada a setState asegura que el widget se redibuja
          ...
          splashColor: Colors.transparent, // Desactiva la animación de onda
          child: ClipOval(
            child: Container(
              width: 48,
              height: 48,
