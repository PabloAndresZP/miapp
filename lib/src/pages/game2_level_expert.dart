...
class GameLevelExpert extends StatefulWidget {
  @override
  _GameLevelExpertState createState() => _GameLevelExpertState();
}

class _GameLevelExpertState extends State<GameLevelExpert> {
  ...
  List<String> exerciseImages = [
    'assets/images/nivel_3_ps.png',
    'assets/images/nivel_3_ps.png',
  ];
  List<String> exerciseAudios1 = [
    'assets/sounds/melodia modo lido.mp3',
    'assets/sounds/melodia modo lido.mp3',
  ];
  List<String> exerciseAudios2 = [
    'assets/sounds/melodia modo frigio.mp3',
    'assets/sounds/melodia modo frigio.mp3',
  ...
  ['Melodia en Modo Lidio', 'Melodia en Modo Frigio'],
  ['Melodia en Modo Lidio', 'Melodia en Modo Frigio'],
  ];
                        ...
                        TextButton(
                          ...
                          onPressed: () {
                            ...
                            Navigator.of(context).pushReplacement(MaterialPageRoute(
                                builder: (context) => GameLevelExpert())); 
                          },
                        ),
                        TextButton(
                          child: Text(
